import { type RapierRaycastVehicle } from './lib/rapier-raycast-vehicle';
...
// touch input
const buttonUpEl = Object.assign(
...
const buttonLeftEl = Object.assign(
	document.createElement( 'button' ),
	{
...
const buttonDownEl = Object.assign(
	document.createElement( 'button' ),
	{
...
const buttonRightEl = Object.assign(
	document.createElement( 'button' ),
	{
...
const buttonBreakEl = Object.assign(
	document.createElement( 'button' ),
	{
...
export const updateKeyInput = ( vehicle: RapierRaycastVehicle ) => {
	...
	forward ? buttonUpEl.classList.add( '-active' ) : buttonUpEl.classList.remove( '-active' );
	left ? buttonLeftEl.classList.add( '-active' ) : buttonLeftEl.classList.remove( '-active' );
	backward ? buttonDownEl.classList.add( '-active' ) : buttonDownEl.classList.remove( '-active' );
	right ? buttonRightEl.classList.add( '-active' ) : buttonRightEl.classList.remove( '-active' );
	brake ? buttonBreakEl.classList.add( '-active' ) : buttonBreakEl.classList.remove( '-active' );

};

// horn
const buttonHornEl = Object.assign(
	document.createElement( 'button' ),
	{
