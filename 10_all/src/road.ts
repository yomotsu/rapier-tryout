...
curvePath.add( new THREE.CatmullRomCurve3( [
	...
	new THREE.Vector3( 0, 20 * heightScale, 50 ),
	new THREE.Vector3( 20, 20 * heightScale, 60 ),
	new THREE.Vector3( 20, 20 * heightScale, 0 ),
	new THREE.Vector3( 0, 20 * heightScale, 0 ),
	new THREE.Vector3( -10, 20 * heightScale, 0 ),
